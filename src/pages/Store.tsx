  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <div className="flex-1 flex flex-col px-6 pt-12">
        ...
        <div className="bg-[#1c1c1e] rounded-3xl p-6 flex gap-5 items-center">
          {/* Rating Circle */}
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[#aeaeb2] text-[13px] leading-relaxed mb-3">
            ...
            <div className="flex items-center justify-between">
              <span className="inline-block bg-[#3a3a3c] text-[#aeaeb2] text-[13px] font-medium px-3 py-1 rounded-md">
